<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-4">
            ...
            <div>
                <a href="{{ route('officer.violations.index') }}" class="p-3 rounded-lg text-white bg-blue-500 hover:bg-blue-200 cursor-pointer mt-10"><i class="fa-solid fa-arrow-left-long"></i> Back to list</a>
            </div>
        </div>
    </div>
</x-app-layout>
