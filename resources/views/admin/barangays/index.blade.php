<x-app-layout>
    <x-slot name="header">Barangays</x-slot>
    <div class="mt-5 text-center">
        <h1 class="text-6xl text-shadow-2xl text-black">List of Barangays</h1>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-6 flex justify-between items-center flex-wrap gap-4">
            <!-- Left: Create Button -->
            <a href="{{ route('admin.barangays.create') }}" class="bg-green-500 text-white rounded px-5 py-3 font-bold">
                Create a Barangay
            </a>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-200">
                <thead class="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100">
                    <tr class="bg-gray-100">
                        ...
                        <th class="py-2 px-4 border-b">Barangay Code</th>
