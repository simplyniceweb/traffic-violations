                    ...
                    <tr @if($province->trashed()) style="opacity: 0.6;" @endif>
                        ...
                        <td class="py-2 px-4 border-b">
                            <div class="inline-flex rounded-md shadow-sm overflow-hidden" role="group">
                                @if ($province->trashed())
                                    <form action="{{ route('admin.provinces.restore', $province->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" 
